...
export default function WhatsappFloatingButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-[60] inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/20 bg-[#25D366] text-white shadow-[0_18px_30px_rgba(37,211,102,0.35)] transition hover:scale-105 hover:bg-[#1ebe5d]"
    >
